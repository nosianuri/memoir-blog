...
const Navigation = () => {
  ...
  return (
    <>
        ...
        <div>
                <Link href="/" className='text-[22px] text-gray-700 font-bold'>merior<span className='text-violet-600'>.</span></Link>
            </div>
            <div className='flex'>
                <ul role='list' className='hidden md:flex space-x-8'>
                    {navigationMenu.map((menu, idx) =>(
                        <li key={menu.label}>
                            ...
                            before:h-[2px] before:bg-violet-600 before:origin-[100%, 50%]
                             before:transition-all before:duration-300 before:ease-in-out 
                             before:scale-x-0 before:scale-y-[1] before:scale-z-[1] 
                             before:will-change-transform hover:before:scale:origin-[100%, 0%]
                              hover:before:scale-x-[1] hover:before:scale-y-[1] hover:before:scale-z-[1]
                               text-[12px] tracking-[2px] uppercase font-semibold pb-2">{menu.label}</Link>
                        </li>
                    ))}
                </ul>
                            ...
                            <Dialog.Panel className="pointer-events-auto w-screen max-w-sm">
                                <div className='flex h-full flex-col overflow-y-scroll bg-white shadow-xl'>
                                    ...
                                    <div>
                                        ...
                                        tracking-[2px] font-bold uppercase bg-violet-600 py-4 px-5 
                                        text-white'>Contact us now</Link>
                                    </div>
                                    </div>
                                </div>
                            </Dialog.Panel>
